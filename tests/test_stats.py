...
def test_bootstrap_seed():
    ...
    a = copia.stats.bootstrap(x, copia.estimators.chao1,
              n_iter=1000, conf=0.95, n_jobs=4,
              seed=2021)
    
    b = copia.stats.bootstrap(x, copia.estimators.chao1,
              n_iter=1000, conf=0.95, n_jobs=4,
              seed=2021)

    c = copia.stats.bootstrap(x, copia.estimators.chao1,
              n_iter=1000, conf=0.95, n_jobs=4,
              seed=54656)
    
    d = copia.stats.bootstrap(x, copia.estimators.chao1,
              n_iter=1000, conf=0.95, n_jobs=4,
              seed=54656)
